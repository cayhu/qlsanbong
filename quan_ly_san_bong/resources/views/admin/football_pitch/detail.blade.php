                                    ...
                                    <div class="carousel-inner">
                                        @foreach ($footballPitchDetails as $item)
                                            <div class="carousel-item @if ($loop->first) active @endif">
                                                <img src="{{ asset("storage/$item->image") }}" class="d-block w-100"
                                                    alt="...">
                                            </div>
                                        @endforeach
                                    </div>
                                ...
                                @else
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="{{ asset('storage/images/foot)ball_pitches/default_football_pitch.png') }}"
                                    ...
                                    <div class="tab-content pt-2 profile">
                                        ...
                                        <div class="tab-pane fade profile-overview active show" id="football-pitch-overview"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-8">{{ $footballPitch->pitchType->quantity }}
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-8">
                                                    {{ $footballPitch->nameFootBallPitchLink() }}
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade pt-3" id="football-pitch-edit" role="tabpanel">
                                            <form action="{{ route('footballPitch.update', $footballPitch->id) }}"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input required value="{{ $footballPitch->price_per_peak_hour }}"
